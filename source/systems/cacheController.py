...
def isDivergenceViewed(ticker:str, timeframe:str, time1:str, time2:str, value):
    return __getViewedDivergences().get(ticker, {}).get(timeframe, {}).get(time1, {}).get(time2, False)
