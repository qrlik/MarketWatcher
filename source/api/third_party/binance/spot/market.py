from api.third_party.binance.error import ParameterArgumentError
from api.third_party.binance.lib.utils import (
...
async def klinesAsync(self, symbol: str, interval: str, **kwargs):
    """Kline/Candlestick Data
    ...
    params = {"symbol": symbol, "interval": interval, **kwargs}
    return await self.queryAsync("/api/v3/klines", params)
